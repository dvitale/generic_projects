...
export default defineConfig({
  ...
  webServer:{command:'../.venv/bin/python -m uvicorn backend.main:app --app-dir .. --host 127.0.0.1 --port 8011',url:'http://127.0.0.1:8011/api/health',env:{CHESS_COACH_DATA:data},reuseExistingServer:false},
})
